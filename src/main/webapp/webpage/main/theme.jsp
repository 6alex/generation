...
<body class="page-header-fixed page-quick-sidebar-over-content">
		...
		<div class="page-header-inner">
			...
			<div class="page-logo">
				<div style="margin-top: 6px;">
					<span style="color: #fff; font-size: 24px;">JEE</span>
					<span style="color: red; font-size: 24px;">IDP</span>
				</div>
				<%-- <a href="#">
			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
					<li class="sidebar-toggler-wrapper">
						...
						<div class="sidebar-toggler" style="margin-bottom: 10px;"></div>
	...
	<![endif]-->
	<script type="text/javascript" src="https://webapi.amap.com/maps?v=1.4.12&key=393585ac164f6e48e25a1e5b832b834c"></script>
