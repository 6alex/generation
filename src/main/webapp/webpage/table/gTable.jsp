		...
		<form id="gTableForm" class="form-horizontal form-bordered" action="/gTable/save" method="post">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<div class="input-icon right">
						<i class="fa"></i>
						<input type="text" class="form-control" name="comment" value="${gTable.comment}" maxlength="50" required />
					</div>
				</div>
			</div>
						...
						<c:forEach items="${gTable.children}" var="child" varStatus="vs">
							<tr>
								...
								<td>
									<div class="input-icon right">
										<i class="fa"></i>
										<select class="form-control" name="children[${vs.index}].code" required>
								...
								<td>
									<div class="input-icon right">
										<i class="fa"></i>
										<input type="text" name="children[${vs.index}].defaultValue" class="form-control" value="${child.defaultValue}" />
									</div>
								</td>
								<td>
									<div class="input-icon right">
										<i class="fa"></i>
										<select type="text" name="children[${vs.index}].isNull" class="form-control">
											<option value="">--请选择--</option>
											<option value="1" <c:if test="${1 eq child.isNull }">selected</c:if>>非空</option>
											<option value="0" <c:if test="${0 eq child.isNull }">selected</c:if>>空</option>
										</select>
									</div>
								</td>
								<td>
									<div class="input-icon right">
										<i class="fa"></i>
										<input type="text" name="children[${vs.index}].comment" class="form-control" value="${child.comment}" />
									</div>
								</td>
								<td>
									<div class="input-icon right">
			...
			<table id="trTemplate">
				<tr>
					...
					<td>
						<div class="input-icon right">
							<i class="fa"></i>
							<select class="form-control" name="children[#index#].code" required>
								<option value="">--请选择--</option>
								<c:forEach items="${dbColumnTypes}" var="dbColumnType">
					...
					<td>
						<div class="input-icon right">
							<i class="fa"></i>
							<input type="text" name="children[#index#].defaultValue" class="form-control" />
						</div>
					</td>
					<td>
						<div class="input-icon right">
							<i class="fa"></i>
							<select type="text" name="children[#index#].isNull" class="form-control">
								<option value="">--请选择--</option>
								<option value="1" <c:if test="${1 eq child.isNull }">selected</c:if>>非空</option>
								<option value="0" <c:if test="${0 eq child.isNull }">selected</c:if>>空</option>
							</select>
					...
					<td>
						<div class="input-icon right">
							<i class="fa"></i>
							<input type="text" name="children[#index#].comment" class="form-control" />
						</div>
					</td>
					<td>
						<div class="input-icon right">
